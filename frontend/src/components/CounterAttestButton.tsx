...
import { buildCounterAttestTransaction } from "../api/buildTransaction";
import { Lucid } from "@lucid-evolution/lucid";
import type { AttestationRow } from "../types/types";

interface CounterAttestButtonProps {
...
const CounterAttestButton = ({
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  lucidInstance, row
}: CounterAttestButtonProps) => {
  ...
  const handleSendAda = async () => {
    ...
    try {
      ...
      const response = await buildCounterAttestTransaction({
  ...
  return (
    ...
    >
      ...
      >
        {isLoading ? "Sending..." : "Counter-Attest"}
      </button>
...
export default CounterAttestButton;
